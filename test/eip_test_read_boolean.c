...
** $Header: /home/cjm/cvs/eip/test/eip_test_read_boolean.c,v 1.1 2008-10-15 13:48:34 cjm Exp $
*/
 ...
 */
static char rcsid[] = "$Id: eip_test_read_boolean.c,v 1.1 2008-10-15 13:48:34 cjm Exp $";
...
int main(int argc, char *argv[])
{
	...
	/* read the boolean */
	if(!EIP_Read_Boolean(handle,PLC_Address,&value))
	{
		EIP_General_Error();
		EIP_Session_Handle_Destroy(&handle);
		return 4;
